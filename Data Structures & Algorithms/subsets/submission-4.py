...
# since we are using dfs, the first subset is [1, 2, 3]
# since we start fram dfs(0)
# is it a leaf?
# no --> update subset
# go to the next number
# index = is a leaf? --> no --> update subset and so on until 3 is reached and return None is passed back
# so from [1, 2, 3] you pop the last number,a dn you have [1, 2] and you increase the index.
# a leaf is reached so you go back
# This is why you see this output [[1,2,3],[1,2],[1,3],[1],[2,3],[2],[3],[]]
#
